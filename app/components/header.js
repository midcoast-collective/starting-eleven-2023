    ...
    <Header>
      <HeaderWrap>
        ...
        <Nav>
          ...
          <StyledLink className="spaceAfter" href="/about#contact">
            Contact
          </StyledLink>
          <StyledLink
            className="icon"
            href="//www.instagram.com/startingeleven.us/"
          >
            <svg
              role="img"
              viewBox="0 0 24 24"
          ...
          <StyledLink className="icon" href="//twitter.com">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <StyledLink className="icon" href="//vimeo.com">
            <svg
              role="img"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
